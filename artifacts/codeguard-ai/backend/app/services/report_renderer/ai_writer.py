...
def _build_prompt(title, instruction, subset):
    return (
        ...
        "7. Do NOT start with 'CodeGuard AI is a full-stack web application...'.\n"
        "8. Vary your opening sentence for each section.\n"
        "9. For the Conclusions and Recommendations section, put each recommendation on its\n"
...
def _specs_from_headings(headings):
