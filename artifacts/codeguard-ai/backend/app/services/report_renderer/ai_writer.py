...
def _build_prompt(title, instruction, subset):
    return (
        ...
        "4. Structure long sections with subheadings on their own line: '## Subheading'.\n"
        ...
        "8. Do NOT start with 'CodeGuard AI is a full-stack web application...'.\n"
        "9. Vary your opening sentence for each section.\n"
        "10. For the Conclusions and Recommendations section, put each recommendation on its\n"
        "   own line, starting with '1. ', '2. ', '3. ', etc.\n"
        "11. For the References section, put each reference on its own line, starting with\n"
        "   '1. ', '2. ', '3. ', etc.\n"
        "12. For lists of features, modules, or bullets, put each item on its own line\n"
        "   starting with '- '.\n\n"
        f"FACTS FOR THIS SECTION:\n{subset}\n\n"
        f"SECTION TITLE: {title}\n"
        f"INSTRUCTIONS: {instruction}\n\n"
        "Return ONLY the section body. No top-level title. Use ## for subheadings."
    )
...
def _call_groq(prompt):
    ...
    system_prompt = (
        ...
        "You write formal, structured internship report sections. "
