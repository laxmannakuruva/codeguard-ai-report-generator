...
def _build_prompt(title, instruction, subset):
    return (
        ...
        "4. Write in flowing academic prose. No markdown syntax.\n"
        "5. Do NOT start with 'CodeGuard AI is a full-stack web application...'.\n"
        "6. Vary your opening sentence for each section.\n"
        "7. For the Conclusions and Recommendations section, put each recommendation on its\n"
        "   own line, starting with '1. ', '2. ', '3. ', etc.\n"
        "8. For the References section, put each reference on its own line, starting with\n"
        "   '1. ', '2. ', '3. ', etc.\n"
        "9. For lists of features, modules, or bullets, put each item on its own line\n"
        "   starting with '- '.\n\n"
